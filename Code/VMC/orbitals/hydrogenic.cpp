...
rowvec3 Hydrogenic::getGradient(int particleNum, int quantumNum, const mat &R){
    double rSingleParticle = 0;
    for (int i = 0; i < nDimensions; i++){
        rSingleParticle += R(particleNum, i)*R(particleNum, i);
    }
...
double Hydrogenic::getLaplacian(int particleNum, int quantumNum, const mat &R){
    double rSingleParticle = 0;
    double laplacian = 0;
    for (int i = 0; i < nDimensions; i++){
        rSingleParticle += R(particleNum, i)*R(particleNum, i);
...
double Hydrogenic::getAlphaDerivative(int particleNum, int quantumNum, const mat &R){
    double rSingleParticle = 0;
    double value = 0;
    for (int i = 0; i < nDimensions; i++){
        rSingleParticle += R(particleNum, i)*R(particleNum, i);
